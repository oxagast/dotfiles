...
sub event_rejoin_kick {
	...
	# Check if we should ignore this server (mainly for ScoutLink)
	if($servtag ~~ @ignore_servers) {
		Irssi::print "Not going to rejoin $rejoinchan in $delay seconds. $servtag is in the ignore list.";
	} else {
